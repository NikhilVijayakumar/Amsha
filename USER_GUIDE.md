...
1. **[Crew Forge (docs/feature/crew_forge/About.md)](docs/feature/crew_forge/About.md)** - Blueprint execution, Job orchestrations, Atomic Builders, file-based mode.
2. **[LLM Factory (docs/feature/llm_factory/About.md)](docs/feature/llm_factory/About.md)** - Model abstractions, LiteLLM bindings, dynamic switching.
3. **[Crew Monitor (docs/feature/crew_monitor/About.md)](docs/feature/crew_monitor/About.md)** - Diagnostics, tracking loops, execution callbacks.
