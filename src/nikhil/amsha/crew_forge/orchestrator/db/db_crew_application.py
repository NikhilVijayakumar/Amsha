...
This module provides a Protocol-compliant application class for database-based
...
class DbCrewApplication(CrewApplication):
    ...
    database-based configuration and shared services for common functionality.
    ...
    def __init__(
        ...
        """
        print("🚀 [DbCrewApp] Initializing database-based crew application...")
        
        context = ErrorContext("DbCrewApplication", "__init__")
        ...
        try:
            ...
            print("✅ [DbCrewApp] Database-based crew application initialized successfully")
    ...
    def run_crew(
        ...
        """
        print(f"🎯 [DbCrewApp] Running crew '{crew_name}' in {mode.value} mode...")
    ...
    def prepare_inputs_for(self, crew_name: str) -> Dict[str, Any]:
        ...
        Raises:
            ...
            CrewConfigurationException: If crew configuration is invalid
        """
        print(f"📦 [DbCrewApp] Preparing inputs for crew '{crew_name}'...")
    ...
    def clean_json(self, output_filename: str, max_retries: int = 2) -> bool:
        ...
        """
        print(f"🧹 [DbCrewApp] Cleaning JSON file: {output_filename}")
