# src/nikhil/amsha/toolkit/crew_linter/guardrails/lda_topic_guardrail.py
...
from nikhil.amsha.toolkit.crew_linter.domain.models.lda_topic_data import LdaTopicResult, LdaTopicInput
