# src/nikhil/amsha/toolkit/crew_linter/guardrails/ber_topic_guardrail.py
from typing import Optional

from bertopic import BERTopic

from nikhil.amsha.toolkit.crew_linter.domain.models.ber_topic_data import BERTopicInput, BERTopicResult
