# Non-Functional Requirements: Amsha Library
...
-   **NFR-PERF-02: Resource Consumption:** The library must be extremely lightweight. The memory and CPU usage should be minimal and scale efficiently. It should not introduce significant overhead to the consuming application.
