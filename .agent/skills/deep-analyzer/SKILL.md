...
- **Analysis Document:** The `docs/paper/Amsha/drafts/details/[N]. [Section Name]/analysis_[section_name].md` containing the baseline facts extracted by `paper-analyzer`.
- **Execution Results (Optional):** If running for Section 6, the user-provided `app_execution_results.md`.

## Output
An augmented analysis document saved to `docs/paper/Amsha/drafts/details/[N]. [Section Name]/augmented_analysis_[section_name].md`.
